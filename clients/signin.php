...
<body>
    <div class="big-container">
        <div class="signin-container">
            <form class="signin-form" id="signin-form" method="post" action="../clients/backend/signindb.php" enctype="multipart/form-data">
                <div class="header">
                    <h2>SIGN IN</h2>
                </div>
                ...
                <div class="wrap">
                    ...
                    <div class="not-register">
                        Not Yet Register? <a href="../clients/signup.php">Register Here!</a>
                    </div>
                </div>
            </form>
        </div>
