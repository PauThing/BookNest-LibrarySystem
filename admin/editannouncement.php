...
<body>
    <div class="big-container">
        ...
        while ($row = sqlsrv_fetch_array($statement)) {
            ...
            $dates[$formattedDate][] = array('title' => $anntitle, 'date' => $date);
        }
        ?>
                    ...
                    <div class="date">
                        ...
                        <div class="anntitle">
                            <?php foreach ($anntitles as $entry) { ?>
                                <div class="link">
                                    <a href="javascript:void(0);" class="title" onclick="openDetail('<?php echo $entry['title']; ?>', '<?php echo $entry['date']; ?>')"><?php echo $entry['title']; ?> • <span><?php echo $entry['date']; ?></span></a>
                                    <a href="../admin/backend/delresourcedb.php?programme=<?php echo $programme; ?>" class="del" onclick="return confirm('Are you sure you want to delete this announcement?');"><i class="fa fa-trash"></i></a>
                                    <br />
                                </div>
                            <?php } ?>
                        </div>
    ...
    <script>
        ...
        function openDetail(title, date) {
            $.ajax({
                type: 'GET',
